...
architecture Behavioral of morse is
    ...
    -- ✅ CHANGE #1: initialize to FF so output is not U at start
    signal decoded_char     : std_logic_vector(7 downto 0) := x"FF";
...
begin
    ...
    begin
        ...
        if rising_edge(clk) then
            case state is
                ...
                when PROCESSING =>
                    ...
                    -- ✅ CHANGE #2: remove output <= decoded_char; (it caused 1-char delay)
     ...
     -- ✅ CHANGE #3: always drive output from decoded_char
     output <= decoded_char;
